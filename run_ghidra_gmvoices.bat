...
"%GHIDRA_HOME%\support\analyzeHeadless.bat" "%PROJECT_DIR%" ma7_arm64 -process "libM7_EmuSmw7.so" -noanalysis -postScript ExportGMVoices.java -scriptPath "%GHIDRA_HOME%\Ghidra\Features\Decompiler\ghidra_scripts"
