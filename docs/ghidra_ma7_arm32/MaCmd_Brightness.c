/* MaCmd_Brightness @ 000ed9d8 278B */


/* YAMAHA::MaCmd_Brightness(unsigned int, int, unsigned int, unsigned int, unsigned char*) */

int YAMAHA::MaCmd_Brightness(uint param_1,int param_2,uint param_3,uint param_4,uchar *param_5)

{
  ...
  iVar9 = DAT_000edaf0;
  param_5[iVar6] = 0x93;
  param_5[iVar5] = *(byte *)((param_4 & 0x7f) + iVar9 + 0xedd88) | 0x80;
  return iVar1;
}
