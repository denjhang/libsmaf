/* MaCmd_MasterVolume @ 000eb3d4 354B */


/* YAMAHA::MaCmd_MasterVolume(unsigned int, int, unsigned int, unsigned char*) */

int YAMAHA::MaCmd_MasterVolume(uint param_1,int param_2,uint param_3,uchar *param_4)

{
  ...
  iVar9 = param_1 * 0x65d0 + DAT_000eb538 + 0xeb3ea;
  *(char *)(iVar9 + 0x3c2) = (char)uVar10;
  if (param_2 >= 0) {
    if (param_2 < 0x80) {
      unaff_r5 = 1;
      uVar10 = 0;
    ...
    uVar10 = (uint)*(byte *)(iVar9 + 0x3c2);
  }
  iVar6 = DAT_000eb53c;
  iVar8 = DAT_000eb53c + 0xeb494;
  iVar4 = 0;
  iVar5 = iVar9;
  while( true ) {
    cVar2 = (char)iVar4;
    ...
    iVar4 = iVar4 + 1;
    uVar10 = (uint)*(byte *)((uint)*(byte *)(iVar9 + 0x3c3) + iVar8 + -0xf8) +
