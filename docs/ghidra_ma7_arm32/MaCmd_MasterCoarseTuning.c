/* MaCmd_MasterCoarseTuning @ 000eb6d0 390B */
...

{
  ...
  iVar10 = param_1 * 0x65d0 + DAT_000eb858 + 0xeb6e6;
  iVar2 = 0;
  uVar1 = *(ushort *)(DAT_000eb85c + (param_3 & 0x7f) * 2 + 0xebf36);
  uVar8 = (uint)uVar1;
  uVar13 = (param_1 & 0xf) << 4;
  iVar12 = 0;
  *(ushort *)(iVar10 + 0x3cc) = uVar1;
  if (*(ushort *)(iVar10 + 0x3ce) != 0x400) {
    uVar8 = *(ushort *)(iVar10 + 0x3ce) * uVar8 >> 10;
  }
  do {
