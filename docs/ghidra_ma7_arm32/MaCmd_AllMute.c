/* MaCmd_AllMute @ 000ef840 5650B */


/* YAMAHA::MaCmd_AllMute(unsigned int, int, unsigned int, unsigned char*) */

int YAMAHA::MaCmd_AllMute(uint param_1,int param_2,uint param_3,uchar *param_4)

{
  ...
  uVar7 = param_3 & 0xf;
  iVar4 = DAT_000f0674 + 0xef85e + param_1 * 0x65d0;
  if ((*(char *)(iVar4 + 0x3c5) == '\x03') && (*(byte *)(iVar4 + 0x3c9) == uVar7)) {
    uVar7 = 0;
    *(undefined1 *)
     (DAT_000f0674 + 0xef85e + param_1 * 0x65d0 + (uint)*(byte *)(iVar4 + 0x3c9) * 0x1e + 2) = 0;
    if (param_2 < 0) {
      *param_4 = 0x80;
      iVar1 = 4;
      iVar11 = 2;
      ...
      param_4[iVar3] = 0x80;
      param_4[iVar10] = *(byte *)(param_1 * 0x65d0 + iVar9 + 0xefdde) | 0x80;
      param_4[iVar2] = 0x80;
    }
    param_4[iVar11] = 0x8a;
    param_4[iVar4] = 0xa0;
    ...
    iVar4 = DAT_000f0678 + 0xef882 + param_1 * 0x65d0 + uVar7 * 0x1e;
    if (*(char *)(iVar4 + 3) == -1) {
      ...
      if (param_2 < 0) {
        *param_4 = 0x80;
        ...
        param_4[iVar3] = 0x80;
        param_4[iVar4] = *(byte *)(iVar9 + param_1 * 0x65d0 + uVar7 * 0x1e + 0xef939) | 0x80;
        param_4[iVar10] = 0x80;
      }
      param_4[iVar2] = 0x8a;
      param_4[iVar11] = 0xa0;
