/* MaCmd_FineTune @ 000edee4 404B */


/* YAMAHA::MaCmd_FineTune(unsigned int, int, unsigned int, unsigned int, unsigned char*) */

int YAMAHA::MaCmd_FineTune(uint param_1,int param_2,uint param_3,uint param_4,uchar *param_5)

{
  ...
  uVar4 = param_3 & 0x1f;
  iVar8 = param_1 * 0x65d0 + DAT_000ee078 + 0xedefa;
  uVar1 = *(ushort *)(DAT_000ee07c + ((param_4 & 0x3fff) >> 4) * 2 + 0xedf4c);
  uVar13 = (uint)uVar1;
  iVar11 = iVar8 + uVar4 * 0x1e;
  uVar5 = (uint)*(ushort *)(iVar11 + 0x18);
  *(ushort *)(iVar11 + 0x1a) = uVar1;
  if (uVar5 != 0x400) {
    uVar13 = uVar5 * uVar13;
  }
  if (uVar5 != 0x400) {
