  ...
  if (uVar1 == 0) {
    if (param_5 != 0) {
      ...
      do {
          ...
          if (*(int *)(param_1 + 0x180) == 0) {
            ...
            iVar5 = (int)*(short *)(*(int *)(param_1 + 0x14c) +
                                   ((*(uint *)(*(int *)(iVar10 + iVar3) +
                                              (uint)(byte)param_1[0x13e] * 4) & iVar7 + iVar6 >> 3)
        ...
        uVar1 = uVar1 + 1;
        iVar7 = CLpf::Generate(*(CLpf **)(param_1 + 0x20c),iVar5);
        ...
        *local_5c = (uint)((ulonglong)uVar8 * (ulonglong)uVar4) >> 0xf |
        ...
        puVar11 = puVar11 + 1;
        *puVar11 = (uint)((ulonglong)uVar9 * (ulonglong)uVar4) >> 0xf |
      ...
      if (*(code **)(param_1 + 0x148) == (code *)0x0) {
        ...
        if (*(int *)(param_1 + 0x180) == 0) {
          ...
          iVar6 = (int)*(short *)(*(int *)(param_1 + 0x14c) +
                                 ((*(uint *)(*(int *)(iVar10 + iVar6) +
                                            (uint)(byte)param_1[0x13e] * 4) & iVar7 + iVar3 >> 3) +
                                  (*(uint *)(param_1 + 0x154) >> 0x16) & 0x3ff) * 2) *
                  ((int)(*(int *)(param_1 + 0x180) * (uint)*(ushort *)(param_1 + 0x176)) >> 0xf) >>
                  0xf;
        }
