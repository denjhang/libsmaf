/* MaHvDrvCN_SetDictionary @ 000e3b60 1506B */
            ...
            if ((uVar13 <= param_2 - 0xd) &&
              ...
              while( true ) {
                ...
                if (iVar12 == iVar11) {
                  ...
                  if (iVar3 != 0) {
                    pbVar8 = param_1 + 1;
                    iVar6 = DAT_000e4148 + 0xe4072;
                    uVar13 = ~((int)param_1 - (int)pbVar16) & 3;
                    uVar17 = *(ushort *)(iVar6 + (*param_1 ^ 0xff) * 2 + 0x9dc) ^ 0xff00;
                    if (pbVar16 != pbVar8) {
                      if (uVar13 == 0) goto LAB_000e40de;
                      if (uVar13 != 1) {
                        pbVar9 = pbVar8;
                        if (uVar13 != 2) {
                          pbVar9 = param_1 + 2;
                          uVar17 = ((uint)*(ushort *)
                                           (iVar6 + ((uint)*pbVar8 ^ uVar17 >> 8) * 2 + 0x9dc) ^
                                   uVar17 << 8) & 0xffff;
                        }
                        pbVar8 = pbVar9 + 1;
                        uVar17 = ((uint)*(ushort *)
                                         (iVar6 + ((uint)*pbVar9 ^ uVar17 >> 8) * 2 + 0x9dc) ^
                                 uVar17 << 8) & 0xffff;
                      }
                      uVar13 = (uint)*pbVar8 ^ uVar17 >> 8;
                      for (pbVar8 = pbVar8 + 1;
                          uVar17 = ((uint)*(ushort *)(iVar6 + uVar13 * 2 + 0x9dc) ^ uVar17 << 8) &
...
LAB_000e40de:
                        uVar17 = ((uint)*(ushort *)
                                 ...
                                 uVar17 << 8) & 0xffff;
                        uVar17 = ((uint)*(ushort *)
                                         (iVar6 + ((uint)pbVar8[1] ^ uVar17 >> 8) * 2 + 0x9dc) ^
                                 uVar17 << 8) & 0xffff;
                        uVar17 = ((uint)*(ushort *)
                                         (iVar6 + ((uint)pbVar8[2] ^ uVar17 >> 8) * 2 + 0x9dc) ^
                                 uVar17 << 8) & 0xffff;
            ...
            if (0x1f < uVar19 - 1 && uVar19 < 0x7f) {
              ...
              while( true ) {
                ...
                if (iVar10 == iVar12) goto LAB_000e3d3c;
    ...
    if (param_3 == 1) {
      if (param_1 == (uchar *)0x0) {
        *(undefined4 *)(DAT_000e4144 + 0xe469e) = 0;
        uVar5 = 0;
      }
      else {
        iVar6 = FUN_000e269c();
        ...
        *(uchar **)(iVar3 + 0xe469e) = param_1;
        uVar5 = 0;
        *(ushort *)(iVar3 + 0xe46a2) = (param_1[0xd] & 0x7f) + (param_1[0xc] & 0x7f) * 0x80;
        *(uint *)(iVar3 + 0xe46a6) = (param_1[0xf] & 0x7f) + (param_1[0xe] & 0x7f) * 0x80;
        *(ushort *)(iVar3 + 0xe46ae) = (param_1[0x11] & 0x7f) + (param_1[0x10] & 0x7f) * 0x80;
        iVar6 = (param_1[0x13] & 0x7f) + (param_1[0x12] & 0x7f) * 0x80;
        *(short *)(iVar3 + 0xe46b0) = (short)iVar6;
        bVar1 = param_1[0x14];
        bVar2 = param_1[0x15];
        iVar6 = iVar6 * 5 + 0x18;
        *(int *)(iVar3 + 0xe46b2) = iVar6;
        *(uint *)(iVar3 + 0xe46aa) = param_2;
        *(uint *)(iVar3 + 0xe46b6) = iVar6 + ((bVar2 & 0x7f) + (bVar1 & 0x7f) * 0x80) * 0xe;
      }
    }
    else {
      uVar5 = 0xfffffffe;
