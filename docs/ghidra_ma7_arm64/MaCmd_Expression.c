/* MaCmd_Expression @ 002352dc 332B */


/* YAMAHA::MaCmd_Expression(unsigned int, int, unsigned int, unsigned int, unsigned char*) */

ulong YAMAHA::MaCmd_Expression(uint param_1,int param_2,uint param_3,uint param_4,uchar *param_5)

{
  ...
  (&DAT_0074a41b)[lVar5] = (char)(param_4 & 0x7f);
  if (0xf < uVar1) {
    uVar11 = MaCmd_Nop(param_2,0,param_5);
    return uVar11;
  }
  uVar8 = (uint)(byte)(&DAT_0052ee00)[(byte)(&DAT_0074a417)[lVar5]] +
