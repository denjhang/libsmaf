/* MaDva_ReleaseFmOnSlot @ 001a5e20 404B */
...

{
  ...
  plVar9 = *(long **)(DAT_005d87a0 + 0x3a00);
  plVar7 = (long *)**(undefined8 **)(DAT_005d87a0 + 0x39f0);
...
LAB_001a5ec4:
          ...
          *(undefined4 *)(lVar4 + (ulong)uVar1 * 0xc + 0x10d0) = 0;
          if ((int)lVar10 != 1) goto LAB_001a5ec4;
          plVar9 = (long *)plVar7[1];
          *(undefined4 *)(plVar7 + 3) = 0;
          lVar10 = *(long *)(lVar4 + 0x39f0);
          *plVar9 = (long)plVar8;
          lVar11 = *(long *)(lVar4 + 0x39f0);
          lVar6 = *plVar7;
LAB_001a5f1c:
