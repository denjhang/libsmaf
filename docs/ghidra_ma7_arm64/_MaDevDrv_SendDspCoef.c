/* _MaDevDrv_SendDspCoef @ 0021c428 4B */


/* YAMAHA::_MaDevDrv_SendDspCoef(unsigned int, unsigned char const*, unsigned int) */

undefined8 YAMAHA::_MaDevDrv_SendDspCoef(uint param_1,uchar *param_2,uint param_3)
