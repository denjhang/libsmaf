/* MaHvDrvCN_SetDictionary @ 00228578 2828B */


/* WARNING: Type propagation algorithm not settling */
/* YAMAHA::MaHvDrvCN_SetDictionary(unsigned char*, unsigned int, unsigned int, void*) */

undefined4 YAMAHA::MaHvDrvCN_SetDictionary(uchar *param_1,uint param_2,uint param_3,void *param_4)

{
  ...
  if (param_3 != 0) {
    ...
    if ((param_1[10] & 0x7f) * 0x80 + (param_1[0xb] & 0x7f) != 2) {
      return 0xfffffffc;
    }
    ...
    DAT_00580090 = param_1;
    DAT_00580098 = (param_1[0xc] & 0x7f) * 0x80 + (param_1[0xd] & 0x7f);
    DAT_0058009c = (param_1[0xe] & 0x7f) * 0x80 + (param_1[0xf] & 0x7f);
    DAT_005800a4 = (param_1[0x10] & 0x7f) * 0x80 + (param_1[0x11] & 0x7f);
    iVar20 = (param_1[0x12] & 0x7f) * 0x80 + (param_1[0x13] & 0x7f);
    DAT_005800a6 = (short)iVar20;
    DAT_005800a8 = iVar20 * 5 + 0x18;
    DAT_005800a0 = param_2;
    DAT_005800ac = DAT_005800a8 + ((param_1[0x14] & 0x7f) * 0x80 + (param_1[0x15] & 0x7f)) * 0xe;
    return 0;
  }
  if (param_1 == (uchar *)0x0) {
    return 0xfffffffc;
...
LAB_00228e34:
        ...
        if ((uint)bVar8 < (uint)bVar6) goto LAB_00228aa8;
        if (bVar7 < pbVar18[3]) {
          return 0xfffffffc;
        }
        bVar6 = param_1[uVar1];
        ...
        if (pbVar18[3] < bVar7) goto LAB_00228e04;
        if (bVar6 < pbVar18[4]) {
          return 0xfffffffc;
        }
        ...
        if (pbVar18[4] < bVar6) goto LAB_00228ad8;
        if (bVar8 < pbVar18[5]) {
          return 0xfffffffc;
        }
        ...
        if (pbVar18[5] < bVar8) goto LAB_00228e34;
        if (bVar6 < pbVar18[6]) {
          return 0xfffffffc;
        }
...
LAB_00228bec:
    ...
    if (iVar20 == iVar3) {
      if (uVar21 <= param_2 - 0xd) {
        iVar20 = 0;
        iVar14 = 0;
        if ((param_1[(ulong)uVar21 + 1] & 0x7f) + (param_1[uVar21] & 0x7f) * 0x80 < 2) {
          while( true ) {
            uVar13 = uVar21 + 4;
            uVar17 = uVar21 + 6;
            uVar22 = uVar21 + 8;
            ...
            if (iVar20 == iVar4) {
              ...
              uVar21 = *(ushort *)(&DAT_004e8940 + (ulong)(*param_1 ^ 0xff) * 2) ^ 0xff00;
              if (pbVar18 != pbVar5) {
                if (uVar15 == 0) goto LAB_0022900c;
                if (uVar15 != 1) {
                  pbVar19 = pbVar18;
                  if (uVar15 != 2) {
                    pbVar19 = param_1 + 2;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00228fe8 with catch @ 00228fc4
                        */
                    /* try { // try from 00228fcc to 00328fd3 has its CatchHandler @ 00228fd4 */
                    uVar21 = ((uint)*(ushort *)
                                     (&DAT_004e8940 + (long)(int)((uint)*pbVar18 ^ uVar21 >> 8) * 2)
                             ^ uVar21 << 8) & 0xffff;
                  }
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00228fcc with catch @ 00228fd4
                        */
                  pbVar18 = pbVar19 + 1;
                    /* try { // try from 00228fd8 to 00328fdb has its CatchHandler @ 00228fdc */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00228fd8 with catch @ 00228fdc
                        */
                    /* try { // try from 00228fe8 to 00328feb has its CatchHandler @ 00228fc4 */
                  uVar21 = ((uint)*(ushort *)
                                   (&DAT_004e8940 + (long)(int)((uint)*pbVar19 ^ uVar21 >> 8) * 2) ^
                           uVar21 << 8) & 0xffff;
                }
                uVar21 = (uint)*(ushort *)
                                (&DAT_004e8940 + (long)(int)((uint)*pbVar18 ^ uVar21 >> 8) * 2) ^
...
LAB_0022900c:
                  uVar21 = ((uint)*(ushort *)
                           ...
                           uVar21 << 8) & 0xffff;
                  uVar21 = ((uint)*(ushort *)
                                   (&DAT_004e8940 + (long)(int)((uint)pbVar18[1] ^ uVar21 >> 8) * 2)
                           ^ uVar21 << 8) & 0xffff;
                  uVar21 = ((uint)*(ushort *)
                                   (&DAT_004e8940 + (long)(int)((uint)pbVar18[2] ^ uVar21 >> 8) * 2)
                           ^ uVar21 << 8) & 0xffff;
                  uVar21 = (uint)*(ushort *)
                                  (&DAT_004e8940 + (long)(int)((uint)pbVar18[3] ^ uVar21 >> 8) * 2)
                           ^ uVar21 << 8;
                }
              }
            ...
            if (1 < (param_1[(ulong)uVar21 + 1] & 0x7f) + (param_1[uVar21] & 0x7f) * 0x80) {
              return 0xfffffffc;
            }
          }
        }
