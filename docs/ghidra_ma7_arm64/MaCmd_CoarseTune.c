/* MaCmd_CoarseTune @ 00235d8c 476B */


/* YAMAHA::MaCmd_CoarseTune(unsigned int, int, unsigned int, unsigned int, unsigned char*) */

ulong YAMAHA::MaCmd_CoarseTune(uint param_1,int param_2,uint param_3,uint param_4,uchar *param_5)

{
  ...
  uVar2 = *(ushort *)(&DAT_0052f750 + (ulong)(param_4 & 0x7f) * 2);
  uVar4 = (uint)uVar2;
  *(ushort *)(&DAT_0074a428 + lVar11) = uVar2;
  if (*(ushort *)(&DAT_0074a42a + lVar11) != 0x400) {
    uVar4 = (uint)uVar2 * (uint)*(ushort *)(&DAT_0074a42a + lVar11) >> 10;
  }
