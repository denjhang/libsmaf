/* MaCmd_MaxGain @ 00232e08 368B */


/* YAMAHA::MaCmd_MaxGain(unsigned int, int, unsigned int, unsigned char*) */

uint YAMAHA::MaCmd_MaxGain(uint param_1,int param_2,uint param_3,uchar *param_4)

{
  ...
  uVar9 = (ulong)param_1;
  uVar6 = param_3 & 0x7f;
  (&DAT_0074a7d3)[uVar9 * 0x65d0] = (char)uVar6;
  if (param_2 < 0) {
    uVar7 = 0;
  }
  else {
    ...
    uVar6 = (uint)(byte)(&DAT_0074a7d3)[uVar9 * 0x65d0];
  }
  ...
  while( true ) {
    ...
    pbVar1 = pbVar8 + 2;
    pbVar8 = pbVar8 + 0x1e;
    uVar6 = (uint)(byte)(&DAT_0052ee00)[(byte)(&DAT_0074a7d2)[uVar9 * 0x65d0]] +
