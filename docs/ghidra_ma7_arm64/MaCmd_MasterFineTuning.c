/* MaCmd_MasterFineTuning @ 00232af0 396B */
...

{
  ...
  uVar3 = *(ushort *)(&DAT_0052ef50 + ((ulong)(param_3 >> 4) & 0x3ff) * 2);
  uVar15 = (uint)uVar3;
  *(ushort *)(&DAT_0074a7de + (ulong)param_1 * 0x65d0) = uVar3;
  if (*(ushort *)(&DAT_0074a7dc + (ulong)param_1 * 0x65d0) != 0x400) {
    uVar15 = (uint)uVar3 * (uint)*(ushort *)(&DAT_0074a7dc + (ulong)param_1 * 0x65d0) >> 10;
  }
