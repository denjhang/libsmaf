/* MaDva_ReleaseFmAllSlot @ 001a6148 436B */
...

{
  ...
  plVar6 = (long *)**(undefined8 **)(DAT_005d87a0 + 0x39e0);
  if (*(long **)(DAT_005d87a0 + 0x39f0) == plVar6) {
    plVar6 = (long *)*plVar6;
  }
  plVar8 = *(long **)(DAT_005d87a0 + 0x3a00);
