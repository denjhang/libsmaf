...
public abstract class L {
    ...
    ArrayList<String> a(ArrayList<View> arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            arrayList2.add(b.d.d.n.f(view));
            b.d.d.n.a(view, (String) null);
        }
        return arrayList2;
    }
    ...
    void a(View view, ArrayList<View> arrayList, ArrayList<View> arrayList2, ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String strF = b.d.d.n.f(view2);
            arrayList4.add(strF);
            if (strF != null) {
                b.d.d.n.a(view2, (String) null);
                String str = map.get(strF);
                int i2 = 0;
                while (true) {
                    if (i2 >= size) {
                        break;
                    ...
                    if (str.equals(arrayList3.get(i2))) {
                        b.d.d.n.a(arrayList2.get(i2), strF);
                        break;
                    }
                    i2++;
                }
    ...
    void a(ArrayList<View> arrayList, View view) {
        if (view.getVisibility() == 0) {
            ...
            if (z) {
                ...
                boolean zA = b.d.d.o.a(viewGroup);
                view2 = viewGroup;
                if (!zA) {
                    int childCount = viewGroup.getChildCount();
